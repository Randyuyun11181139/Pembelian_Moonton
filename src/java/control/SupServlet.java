...
public class SupServlet extends pesan {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           String namasupp = request.getParameter("namasupp");
           String alamat = request.getParameter("alamat");
           String tlp = request.getParameter("tlp");
           supplier var = new supplier(kodesupp,namasupp,alamat,tlp);
           ...
           if(aksi.equals("SIMPAN")) {
               ...
               out.print(super.proses(var.toDelete(), URL, "HAPUS"));
                ...
                Logger.getLogger(SupServlet.class.getName()).log(Level.SEVERE, null, ex);
