...
<table border="0">
    <form action="AkunServlet" method="post" onsubmit="return validasi_inputAkun(this)">
        ...
        <tr>
            <td>Nomor Akun</td> <td>: <input type="text" name="noakun" onkeypress="return hanyaAngka(event)" value="${param.no_akun}"/> </td>
        </tr>
         <tr>
            <td>Nama Akun</td> <td>: <input type="text" name="nmakun" value="${param.nm_akun}"/> </td>
        </tr>
        <tr>
    ...
    <form action="" method="post">
        ...
        <br><table border="1" width="100%" cellpadding="0" cellspacing="0">
            ...
            <tr class="isi">
                ...
                <td valign='top'><a href='AkunServlet?aksi=HAPUS&noakun=${rowakun[0]}'> Hapus </a> | <a href='beranda.jsp?halaman=tampilakun&aksi=GANTI&no_akun=${rowakun[0]}&nm_akun=${rowakun[1]}'> Edit </a>
                </td>
            </tr>
            </c:forEach>
        </table>
